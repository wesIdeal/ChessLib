...
namespace ChessLib.MagicBitboard.Tests.MoveValidation.CastlingRules
{
    ...
    class CastlingHasNoPiecesBlocking : ChessLib.MagicBitboard.MoveValidation.CastlingRules.CastlingHasNoPiecesBlocking
    {
        ...
        private void AssertOccupiedExceptionThrown(MoveExt move)
        {
            ...
            var result = Validate(_biOccupied,
                BoardHelpers.GetBoardPostMove(_biOccupied.PiecesOnBoard, _biOccupied.ActivePlayerColor, move), move);
