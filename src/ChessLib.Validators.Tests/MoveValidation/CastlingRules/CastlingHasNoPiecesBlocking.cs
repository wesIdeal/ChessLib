...
namespace ChessLib.Validators.Tests.MoveValidation.CastlingRules
{
    ...
    {
        BoardFENInfo _biOccupied, _biNonOccupied;
        [SetUp]
        public void Setup()
        {
            _biOccupied = new BoardFENInfo("r1N1k1Nr/8/8/8/8/8/8/R1B1K1BR w KQkq - 0 1");
            _biNonOccupied = new BoardFENInfo("r3k2r/8/8/8/8/8/8/R3K2R w KQkq - 0 1");
        }
        ...
        private void AssertOccupiedExceptionThrown(MoveExt move)
        {
            ...
            var result = Validate(_biOccupied,
                BoardHelpers.GetBoardPostMove(_biOccupied.PiecePlacement, _biOccupied.ActivePlayer, move), move);
