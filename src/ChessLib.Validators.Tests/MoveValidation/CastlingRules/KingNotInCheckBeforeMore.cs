...
namespace ChessLib.Validators.Tests.MoveValidation.CastlingRules
{
    ...
    class KingNotInCheckBeforeMove : ChessLib.Validators.MoveValidation.CastlingRules.KingNotInCheckBeforeMove
    {
        ...
        private readonly BoardFENInfo _biNotInCheck = new BoardFENInfo("r3k2r/8/8/8/8/8/8/RRRRKRRR b KQkq - 0 1");
        private readonly BoardFENInfo _biInCheck = new BoardFENInfo("r3k2r/8/8/8/8/8/4Q3/RRRRKRRR b KQkq - 0 1");
