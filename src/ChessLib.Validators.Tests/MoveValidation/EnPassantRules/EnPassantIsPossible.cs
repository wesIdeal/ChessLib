...
namespace ChessLib.Validators.Tests.MoveValidation.EnPassantRules
{
    ...
    class SourceIsPawn : ChessLib.Validators.MoveValidation.EnPassantRules.SourceIsPawn
    {
        ...
        {
            var board = new BoardFENInfo("rnbqkbnr/pppp1ppp/8/3Bp3/8/8/PPP1PPPP/RNBQKBNR w KQkq e6 0 2");
        ...
        {
            var board = new BoardFENInfo("rnbqkbnr/pppp1ppp/8/3Pp3/8/8/PPP1PPPP/RNBQKBNR w KQkq e6 0 2");
            var move = MoveHelpers.GenerateMove(35, 44);
    ...
    class SourceIsCorrectRank : ChessLib.Validators.MoveValidation.EnPassantRules.SourceIsCorrectRank
    {
        ...
        {
            var board = new BoardFENInfo("rnbqkbnr/ppp2ppp/3p4/3Pp3/8/5N2/PPP1PPPP/RNBQKB1R w KQkq - 0 3");
        ...
        {
            var board = new BoardFENInfo("rnbqkbnr/ppp1pppp/8/8/1P1pP3/P7/2PP1PPP/RNBQKBNR b KQkq e3 0 1");
