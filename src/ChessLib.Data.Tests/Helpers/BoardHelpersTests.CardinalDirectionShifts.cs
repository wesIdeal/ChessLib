...
namespace ChessLib.Data.Tests.Helpers
{
    public class ShiftHelpers
    {
        ...
        [TestCase("r3k2r/8/8/8/8/8/8/R3K2R b - - 0 1", CastlingAvailability.BlackKingside, 0x4000000000000000ul,
            0x2100000000000000ul)]
        [TestCase("r3k2r/8/8/8/8/8/8/R3K2R b - - 0 1", CastlingAvailability.BlackQueenside, 0x400000000000000ul,
        ...
        private static bool IsOnRank(ushort square, ushort rank)
        {
            return square.GetRank() == rank;
        }
        ...
        private static bool IsOnFile(ushort index, ushort file)
        {
            return index.GetFile() == file;
        }
