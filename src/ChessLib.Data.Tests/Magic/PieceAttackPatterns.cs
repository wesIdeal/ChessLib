...
namespace ChessLib.Data.Tests.Magic
{
    ...
    public class PieceAttackPatterns
    {
        ...
        [TestCase(0, new ulong[] { 0ul/*King moves are same as attacks*/, 0ul, 282578800148862ul, 18049651735527936ul, 132096ul, 0ul, 0ul }, "Piece on a1")]
        [TestCase(1, new ulong[] { 0ul/*King moves are same as attacks*/, 0ul, 565157600297596ul, 70506452091904ul, 329728ul, 0ul, 0ul }, "Piece on b1")]
        [TestCase(2, new ulong[] { 0ul/*King moves are same as attacks*/, 0ul, 1130315200595066ul, 275415828992ul, 659712ul, 0ul, 0ul }, "Piece on c1")]
        [TestCase(3, new ulong[] { 0ul/*King moves are same as attacks*/, 0ul, 2260630401190006ul, 1075975168ul, 1319424ul, 0ul, 0ul }, "Piece on d1")]
        [TestCase(4, new ulong[] { 0ul/*King moves are same as attacks*/, 0ul, 4521260802379886ul, 38021120ul, 2638848ul, 0ul, 0ul }, "Piece on e1")]
        [TestCase(5, new ulong[] { 0ul/*King moves are same as attacks*/, 0ul, 9042521604759646ul, 8657588224ul, 5277696ul, 0ul, 0ul }, "Piece on f1")]
        [TestCase(6, new ulong[] { 0ul/*King moves are same as attacks*/, 0ul, 18085043209519166ul, 2216338399232ul, 10489856ul, 0ul, 0ul }, "Piece on g1")]
        [TestCase(7, new ulong[] { 0ul/*King moves are same as attacks*/, 0ul, 36170086419038334ul, 567382630219776ul, 4202496ul, 0ul, 0ul }, "Piece on h1")]
        ...
        [TestCase(56, new ulong[] { 0ul/*King moves are same as attacks*/, 0ul, 9079539427579068672ul, 567382630219776ul, 1128098930098176ul, 0ul, 0ul }, "Piece on a8")]
        [TestCase(57, new ulong[] { 0ul/*King moves are same as attacks*/, 0ul, 8935706818303361536ul, 1134765260406784ul, 2257297371824128ul, 0ul, 0ul }, "Piece on b8")]
        [TestCase(58, new ulong[] { 0ul/*King moves are same as attacks*/, 0ul, 8792156787827803136ul, 2832480465846272ul, 4796069720358912ul, 0ul, 0ul }, "Piece on c8")]
        [TestCase(59, new ulong[] { 0ul/*King moves are same as attacks*/, 0ul, 8505056726876686336ul, 5667157807464448ul, 9592139440717824ul, 0ul, 0ul }, "Piece on d8")]
        [TestCase(60, new ulong[] { 0ul/*King moves are same as attacks*/, 0ul, 7930856604974452736ul, 11333774449049600ul, 19184278881435648ul, 0ul, 0ul }, "Piece on e8")]
        [TestCase(61, new ulong[] { 0ul/*King moves are same as attacks*/, 0ul, 6782456361169985536ul, 22526811443298304ul, 38368557762871296ul, 0ul, 0ul }, "Piece on f8")]
        [TestCase(62, new ulong[] { 0ul/*King moves are same as attacks*/, 0ul, 4485655873561051136ul, 9024825867763712ul, 4679521487814656ul, 0ul, 0ul }, "Piece on g8")]
        [TestCase(63, new ulong[] { 0ul/*King moves are same as attacks*/, 0ul, 9115426935197958144ul, 18049651735527936ul, 9077567998918656ul, 0ul, 0ul }, "Piece on h8")]
        #endregion
